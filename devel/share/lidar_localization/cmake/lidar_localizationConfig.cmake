...
if("TRUE" STREQUAL "TRUE")
  set(lidar_localization_SOURCE_PREFIX /home/ubuntu/Localization2023_ws/src/lidar_localization)
  set(lidar_localization_DEVEL_PREFIX /home/ubuntu/Localization2023_ws/devel)
  ...
  set(lidar_localization_INSTALL_PREFIX /home/ubuntu/Localization2023_ws/install)
...
if(NOT "/home/ubuntu/Localization2023_ws/src/lidar_localization/include " STREQUAL " ")
  set(lidar_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/Localization2023_ws/src/lidar_localization/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Localization2023_ws/src/lidar_localization/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lidar_localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "lidar_localization;lidar_localization_nodelets;beacon_scan_tracker;area_obstacles_extractor")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(lidar_localization_EXPORTED_TARGETS ${${lidar_localization_dep}_EXPORTED_TARGETS})
endforeach()
