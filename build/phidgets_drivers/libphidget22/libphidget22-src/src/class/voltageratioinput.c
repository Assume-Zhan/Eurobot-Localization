	...
	case BP_SETBRIDGEGAIN:
		...
		if (res == EPHIDGET_OK) {
			...
			case PHIDUID_1046_1:
				...
				bridgeSendToChannel((PhidgetChannelHandle)ch, BP_PROPERTYCHANGE, 1, "%s", "MinVoltageRatio");
				bridgeSendToChannel((PhidgetChannelHandle)ch, BP_PROPERTYCHANGE, 1, "%s", "MaxVoltageRatio");
				break;
			}
		}
		break;
